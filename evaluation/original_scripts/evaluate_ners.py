...
from evaluation.original_scripts.brat_format import read_file
import os
...
rel_types = {"NNG", "NNT", "NPS", "FNG", "FNT", "FPS", "PNG", "PNT", "PPS",
             "GOL", "TSK"}


def compute_precision_and_recall(true_positive, false_positive,
                                 false_negative):
    """
